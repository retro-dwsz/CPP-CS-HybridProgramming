 ...
 * Windows  clang++ -shared -o CPP_Main_WIN_<arch>.dll ./CPP_SRC/CPP_Main.cpp -O3 -fPIC
 * Linux    clang++ -shared -o CPP_Main_LINUX_<arch>.dll ./CPP_SRC/CPP_Main.cpp -O3 -fms-extensions -fPIC
 * 
